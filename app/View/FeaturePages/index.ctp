<div class="container">
	<h2><?php echo __('Feature Pages'); ?></h2>
	...
	<tr>
		...
		<td><?php echo h($featurePage['FeaturePage']['modified']); ?>&nbsp;</td>
		<td><?php echo h($featurePage['FeaturePage']['created']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($featurePage['FeaturePage']['sequence']); ?>&nbsp;</td>
		<td class="actions">
